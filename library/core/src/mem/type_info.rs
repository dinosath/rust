...
/// # Stability of `args`
///
/// The [`args`](Attribute::args) field contains a textual rendering of the
/// attribute's arguments. Its exact format is **not** stable and may change
/// between compiler versions.
// FIXME(#146922): consider a structured `args` representation in the future.
#[derive(Debug, PartialEq, Eq)]
#[non_exhaustive]
#[unstable(feature = "type_info", issue = "146922")]
